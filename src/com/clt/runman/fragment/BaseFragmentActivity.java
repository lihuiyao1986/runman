...
public class BaseFragmentActivity extends FragmentActivity implements HttpRequestClientCallback {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        creatSingleton ();
        // 5.初始化上下文对象
        appContext = getRunManApplication ();
    }
    ...
    */
    ...
    protected void handleHttpFail(String errorcode,String errorMsg,int reqTag){
        ...
        if (httpFailShowAlertView (reqTag)) {
            DialogUtils.showToast (getRunManApplication (), errorMsg + "[" + errorcode + "]");
        }
    }
